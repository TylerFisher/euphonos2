...
```
cd euphonos2
mkvirtualenv --no-site-packages euphonos2
...
```
* * * * * ubuntu bash /home/ubuntu/apps/euphonos2/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|euphonos2|tweet|`location`||||
|euphonos2|facebook|`location`||||
|euphonos2|email|`location`||||
|euphonos2|new-comment||||
|euphonos2|open-share-discuss||||
|euphonos2|close-share-discuss||||
|euphonos2|summary-copied||||
|euphonos2|featured-tweet-action|`action`||``tweet_url``|
|euphonos2|featured-facebook-action|`action`||``post_url``|
